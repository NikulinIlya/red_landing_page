                        ...
                        <div class="hero_section">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-5">
                                    {{--{{ asset('assets/img/main_device_image.png') }}--}}
    ...
    <section class="page_section team" id="team"><!--main-section team-start-->
        <div class="container">
            ...
            <div class="team_section clearfix">
                ...
                @foreach($people as $k=>$ppl)
                    <div class="team_area">
                        <div class="team_box wow fadeInDown delay-0{{ ($k*3 + 3) }}s">
                            <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>
                            {{ Html::image('assets/img/'.$ppl->images, $ppl->name) }}
                            <ul>
                        ...
                        <h3 class="wow fadeInDown delay-0{{ ($k*3 + 3) }}s">{{ $ppl->name }}</h3>
                        <span class="wow fadeInDown delay-0{{ ($k*3 + 3) }}s">{{ $ppl->position }}</span>
                        <p class="wow fadeInDown delay-0{{ ($k*3 + 3) }}s">{{ $ppl->text }}</p>
                    </div>
                @endforeach
            </div>
        </div>
